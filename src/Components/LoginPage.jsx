    ...
    <div className="w-full h-full flex justify-center">
      <div className="w-[70%] h-full">
        ...
        <form className="w-full h-full flex justify-center items-center flex-col gap-4">
          <h1 className="text-4xl mb-1">Login</h1>
          <input
            type="text"
          ...
          />
          <div
            className={`flex bg-Background w-[50%] rounded-2xl outline-none border items-center justify-between px-6 ${
          ...
          <div className="text-center py-2 text-[#616161]">
            ...
            <Link className="underline text-[#000]" to={"/Airbnb/register"}>
              Register now
            </Link>
          </div>
        </form>
